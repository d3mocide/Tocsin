...
# TOCSIN_MODE selects the compose profile; see docs/design-spec.md §1, §8.
up-offgrid:
...
# CPU throughput benchmark for the channelizer, per docs/design-spec.md §6
...
# (docs/design-spec.md §8). Not yet implemented: stt_worker (milestone 4)
...
fetch-models:
	...
	@echo "See docs/design-spec.md §8 and the build order in README.md."
	@exit 1
