from live_audio import _build_redis_client


def test_no_redis_url_means_no_client(monkeypatch):
    monkeypatch.delenv("LIVE_AUDIO_REDIS_URL", raising=False)
...
def test_a_configured_url_builds_a_client(monkeypatch):
    ...
    monkeypatch.setenv("LIVE_AUDIO_REDIS_URL", "redis://redis:6379/0")
