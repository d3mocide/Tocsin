...
def test_no_serial_client_reports_mesh_disabled():
    sender = DualPathSender(serial_client=None, mqtt_client=None, mode="offgrid")
...
def test_no_serial_client_still_relays_over_mqtt_in_hybrid():
    ...
    mqtt = FakeMqtt()
    sender = DualPathSender(serial_client=None, mqtt_client=mqtt, mode="hybrid")
...
def test_no_serial_client_offgrid_does_not_touch_mqtt():
    mqtt = FakeMqtt()
    sender = DualPathSender(serial_client=None, mqtt_client=mqtt, mode="offgrid")
